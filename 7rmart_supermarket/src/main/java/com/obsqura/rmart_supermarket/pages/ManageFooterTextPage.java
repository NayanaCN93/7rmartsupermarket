...
public class ManageFooterTextPage {
	...
	@FindBy(xpath="(//a[@class='btn btn-sm btn btn-primary btncss'])[1]") WebElement clicEditButton;
	...
	@FindBy(xpath="//button[@class='btn btn-block-sm btn-info']") WebElement ubdatebutton;
	...
	public ManageFooterTextPage editfooterdata(String address,String email,String num) {
		 addressField.clear();
